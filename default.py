...
default_config = {
    ...
    "val_data_dir"      : "data/test",                   #data dir containing validation set
    ...
    "weight_path_test"  : './snaps/base3_liverAndLesionSeg_elu_withCRF_trainWithVal', #resume from specific ckpt file
